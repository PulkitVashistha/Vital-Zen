...
class HealthConnectManager(private val context: Context) {
    ...
    suspend fun readTotalSteps(): List<StepsRecord> {
//        requestAndCheckPermissions(readPermissions)
        ...
        val totalStepsRecord = ReadRecordsRequest(
            recordType = StepsRecord::class,
            timeRangeFilter = TimeRangeFilter.between(firstDay.toInstant(), lastDay.toInstant()),
        )
        val totalStepsRecordResponse = healthConnectClient.readRecords(totalStepsRecord)
        return totalStepsRecordResponse.records
    }
    ...
    suspend fun readHeartRate(): List<HeartRateRecord> {
        ...
        val heartRateRecord = ReadRecordsRequest(
            recordType = HeartRateRecord::class,
            timeRangeFilter = TimeRangeFilter.between(firstDay.toInstant(), lastDay.toInstant()),
        )
        val totalStepsRecordResponse = healthConnectClient.readRecords(heartRateRecord)
        return totalStepsRecordResponse.records
    }
